 ...
 * functions ->add technician and add Forms
 *
 */
session_start();
        if (isset($_SESSION['email'])&&isset($_SESSION['password'])&&isset($_SESSION['id'])&&isset($_SESSION['rid'])&&isset($_SESSION['userrole'])) {
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <br><br><br>   <h1><?php    echo($_SESSION['bids'].".".$_SESSION['buildnames']); ?></h1>
            </h1>
            <hr>
          </div>
