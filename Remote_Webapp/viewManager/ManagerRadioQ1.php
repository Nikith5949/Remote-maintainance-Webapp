 ...
 * finishes creating radio question
 * only for managers
 */
session_start();
         /*
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <br><br><br>     <h1> form Radio creation</h1>
            </h1>
            <hr>
          </div>
...
<form method="POST" action="../modelManager/ManagerRadioBoxCollection.php">

            Enter the forms question :
            <input type="text" class="form-control form-control-sm" name="textbox" value="<?php echo $question; ?>" class="textInput">
            <br> <br>
            Enter the content of the options :<br>
    <?php
/*
 * If any options for questions prints it out on a textbox
 */
for ($x = 0; $x <  $option; $x++) {
    echo "\nOption-".$x; ?>  
    <input type="text" class="form-control form-control-sm" name="Option[]" class="optionInput">
