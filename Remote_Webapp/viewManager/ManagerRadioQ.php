 ...
 * and fill the number of options it will take you too RadioQ2.
 */
session_start();
        /*
...
<form method="POST" action="./ManagerRadioQ1.php">

            Enter the forms question :
            <input type="text" class="form-control form-control-sm" name="textbox" class="textInput"><br>
    Enter the number of options :
<input type="number" class="form-control form-control-sm" name="option" class="optionInput">
<br>
