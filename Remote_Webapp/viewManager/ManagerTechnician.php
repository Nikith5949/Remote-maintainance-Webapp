        ...
        if (isset($_SESSION['email'])&&isset($_SESSION['rid'])&&isset($_SESSION['password'])&&isset($_SESSION['id'])&&isset($_SESSION['userrole'])) {
            ...
            if (isset($_POST['email'])) {
                ...
                if (isset($_SESSION['buildnames'])&& isset($_SESSION['bids'])) {
                    ...
                    if ($tid==0) {
                        header("location:ManagerBuilding.php");
                    ...
                    if ($z==1) {
                        echo '<script type="text/javascript">alert("Technician has been added to Building");location="AllManager.php";</script>';
                    //header("location:Building.php");
                    } else {
                        echo '<script type="text/javascript">alert("Technician cannot be added to Building");location="AllManager.php";</script>';
                    }
                    //header("location:Building.php");
                } else {
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <br><br><br>     <h1>enter the Technician details you want to add to the current building</h1>
            </h1>
            <hr>
          </div>
...
<br>
  ...
  <br>
 <a href="./ManagerBuilding.php">HOME</a>
    </form>
