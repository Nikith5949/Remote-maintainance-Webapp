...
session_start();
        if (isset($_SESSION['email'])&&isset($_SESSION['rid'])&&isset($_SESSION['password'])&&isset($_SESSION['id'])&&isset($_SESSION['userrole'])) {
            ...
            if (isset($_POST['formname'])) {
                ...
                /*
                 * Gets the fqn(number of question ->\counter) for the current Form
                 */
                /*
                 * So that we canuse it when you want to add another question(we should increment it)
                 */
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <br><br><br>       <h1><?php    echo($_SESSION['fid'].".".$_SESSION['formname']."  ".$_SESSION['fqn']); ?></h1>
            </h1>
            <hr>
          </div>
...
<form action="ManagerTextBoxQ.php">
...
<form action="ManagerRadioQ.php">
    <input type="submit" class="btn btn-primary text-light" value="create Radio question" />
    
</form>
    
    <form method="POST" action="">
    <input type="submit" class="btn btn-primary text-light" name="newform" value="newform" />
    
</form>  
    
    <form method="POST" action="./ManagerForm.php">
    <input type="submit" class="btn btn-primary text-light" name="newform" value="View Form" />
    
</form>  
         
         <form method="POST" action="ManagerFormResult.php">
 ...
 <br><br>
   ...
   <a href="./ManagerAddForm.php">back</a>
