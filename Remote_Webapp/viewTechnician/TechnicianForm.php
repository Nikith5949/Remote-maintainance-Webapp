...
session_start();
        ...
        if (isset($_SESSION['email'])&&isset($_SESSION['rid'])&&isset($_SESSION['password'])&&isset($_SESSION['id'])&&isset($_SESSION['userrole'])) {
            if (isset($_SESSION['formname'])&&isset($_SESSION['fid'])) {
                ...
                header("location:TechnicianAddForm.php");
            }
...
<body id="page-top">
    ...
    <?php
    /*
     * Gets the rows from the table taxt boxes
     */
    ...
    <form method="POST" action="../modelTechnician/TechnicianFormCollection.php">
    <?php $i=0;
    ...
    $j=$value['TextBoxID'];
                    /*
                     * Checks if it is a textbox kind or radioButton kind based on that creates suck kinds of elements in the form
                     */
 ...
 <a href="./TechnicianFormButton.php">back</a>
