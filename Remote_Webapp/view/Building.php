...
session_start();
        ...
        if (isset($_SESSION['email'])&&isset($_SESSION['password'])&&isset($_SESSION['id'])&&isset($_SESSION['userrole'])) {
            if ($_SESSION['userrole']=="Admin") {
                 ...
                 */
                $result=GetAllBuilding($conn, "Building", $mysqli);
                ...
                /*
                 *  If the $_POST['build'] is set (that is when we try to create a new building that rediects to the same page),
                 *  we insert the building details into the Building table.
                 */
                if (isset($_POST['build'])&& $_POST['build']!="") {
                    ...
                    InsertBuilding($conn, $name, $table, $address, $mysqli);
                } ?> 
...
if ($c>0) {
    ...
    <div class="col-sm">
        <form class="sideby" method="POST" action="AllAdmin.php"> 
...
<input type="text" class="form-control form-control-sm" name="build" class="optionInput">
<br>
Address:
<input type="text" class="form-control form-control-sm" name="address" class="optionInput">
<br>
