...
if (isset($_SESSION['email'])&&isset($_SESSION['password'])&&isset($_SESSION['id'])&&isset($_SESSION['userrole'])) {
    ...
    if (isset($_SESSION['buildnames'])&& isset($_SESSION['bids'])) {
        ...
        if (isset($_POST['name'])&& $_POST['name']!="") {
            ...
            if ($id>0) {
                /*
                 * Links the form to the building in the BuildingForm
                 */
                addFormtoBuilding($conn, $bid, $id, "BuildingForm", $mysqli);
            } else {
...
if ($c>0) {
    ...
    <div class="col-sm">
        <form class="sideby" method="POST" action="FormButton.php"> 
