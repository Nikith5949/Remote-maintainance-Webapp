<?php
/*
 * MinMaxText Question page
 * Supply Min Max and Question
 * Then it creates it
 */
session_start();
        /*
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <br><br><br>    <h1> Adding text box to Form</h1>
            </h1>
            <hr>
          </div>
...
<form method="POST" action="../model/TextBoxCollectionMM.php">

    Enter the forms question :<br><br> <input type="text"  name="textbox" class="form-control form-control-sm" class="textInput">
    <br>enter the min value:<input type="number"  name="min" class="form-control form-control-sm" class="textInput">
    <br>enter the max value:<input type="number"  name="max" class="form-control form-control-sm" class="textInput">       
    <br>
