        ...
        if (isset($_SESSION['email'])&&isset($_SESSION['password'])&&isset($_SESSION['id'])&&isset($_SESSION['userrole'])) {
            ...
            if (isset($_POST['mansub'])) {
                ...
                if (isset($_SESSION['buildnames'])&& isset($_SESSION['bids'])) {
                    ...
                    $email=$_POST['email'];
                    $table='Manager';
                    //add managers to the table manager
                    $mid=InsertManager($conn, $bname, $address, $phno, $email, $table, $mysqli);
                    if ($mid==0) {
                    ...
                    //insert the manager and building link
                    addManagertoBuilding($conn, $bid, $mid, 'BuildingManager', $mysqli);
...
<input type="text" class="form-control form-control-sm" name="Mname" class="optionInput" required>
<br>
Address:
...
<br>
     ...
     <input type="submit" class="btn btn-primary text-light" name="mansub" value="submit" required>
